...
import { ProfileStackList, RootTabParamList } from '../../../navigation/Navigation.interface';
      ...
      <ScrollView
        ...
        <View className='flex-row justify-between mb-[12px]'>
          ...
          <View className='flex-row gap-[25px]'>
            <Pressable className='relative' onPress={()=>navigation.navigate('Notice')}>
        ...
        <Modal animationType='slide' transparent={true} visible={settingModal}>
          <Pressable onPress={()=>setSettingModal(false)}
          className='flex-1 w-full bg-[#00000070] justify-end'>
            <SettingModal setModalVisible={setSettingModal}/>
          </Pressable>
        </Modal>
      </ScrollView>
    </BackgroundColor>
